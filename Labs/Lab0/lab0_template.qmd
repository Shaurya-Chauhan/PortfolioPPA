...
- Rows: 50,000
- Columns: 7 
- Variable types: dbl and chr
- Problematic names: Engine size, Fuel type and Year of manufacture for they all have spaces
...
**Your answer:** Tibble is showing 10 at a time, in this same space. Regular dataframe has all the 50k rows and 7 columns displayed in a separate tab.
...
**Your answer:** Because it had spaces in it that would cause an issue if we did not specify it as character type data using backticks. 'year' doesnt have that issue
